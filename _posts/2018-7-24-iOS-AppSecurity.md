...
Но даже тут стоит быть тоже внимательным, так как *HTTPS* дает лишь механизм для поддержки шифрования, а обработать мы его должны сами, или с помощью широко используемых проверенных библиотек. В чем разница можно прочитать [здесь] (https://thedifference.ru/chem-otlichaetsya-http-ot-https/).
...
Тут важно обратить внимание на то, что клиент не проверяет, является ли текущий сертификат тем, который использует сервер.
Это является возможной брешью в безопасности, так как хранилище сертификатов на устройстве может быть скомпрометировано: пользователь может установить небезопасные сертификаты.
...
Про реализацию пиннинга с помощью *Alamofire* можно посмотреть на [этом] (http://www.roxiemobile.ru/blog/ssl-pinning-v-ios-na-swift/) сайте.
...
- [Серия статей "Можно ли украсть деньги из мобильного банкинга?" от компании Digital Security](https://habr.com/company/dsec/blog/229373/)

- [Безопасность данных в разработке мобильных приложений](https://habr.com/post/327760/)

- [Современные способы аутентификации и безопасность iOS-устройств](https://habr.com/company/e-Legion/blog/245367/)

- [Основы безопасности: Keychain и Хеширование](https://habr.com/post/351116/)

- [Безопасность IOS-приложений (часть 36) – Обход certificate pinning при помощи SSL Kill Switch](https://www.securitylab.ru/analytics/473562.php)
